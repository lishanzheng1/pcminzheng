 ...
 * 26.部门列表
 */
export const queryDeptList = (params) => ajax(`${BASE_URL}/sys/dept/list`, params, 'GET');
...
export const update = (params, requestMethod) => ajax(`${BASE_URL}/sys/user/updateInfo`, params, requestMethod);
/**
 * 29.用户删除
 */
...
/**
 * 33.1 采集信息  下拉选择   分为 :  老年人类别   年龄   关爱服务需求
 */
export const infoSelect = (params) => ajax(`${BASE_URL}/info/listWhere`, params, "GET");
